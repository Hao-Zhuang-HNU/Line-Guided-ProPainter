...
class InpaintGenerator(BaseNetwork):
    ...
    def forward(self, masked_frames, completed_flows, masks_in, masks_updated, num_local_frames, line_guidance=None, interpolation='bilinear', t_dilation=2):
        ...
        Args:
            ...
            line_guidance: optional wireframe condition [B,T,1,H,W], white lines in [0,1].
                If None, a zero-line map is used so old inference/training calls remain valid.
        """

        l_t = num_local_frames
        b, t, _, ori_h, ori_w = masked_frames.size()

        # extracting RGB/mask features
